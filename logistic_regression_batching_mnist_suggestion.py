...
def flatten_images(images):   ######## Not Necessary, Already flattened from dataloader transforms
    # Get batch size
...
def train_model(model, train_dataloader):
    ...
    for batch in train_dataloader:
        ...
        train_images = flatten_images(images)   ######## Not Necessary, Already flattened from dataloader transforms
...
def test_model(model, test_dataloader):
    ...
    for batch in test_dataloader:
        ...
        # Flatten images from 2D array to 1D array
        test_images = flatten_images(images)   ######## Not Necessary, Already flattened from dataloader transforms
    ...
    for max_iter in max_iters:
        for solver in solvers:
            for batch_size in batch_sizes:
                ...
                print("Max iterations: " + str(max_iter)) ######## Don't need to print this
                print("Solver: " + solver) ######## Don't need to print this
                print("Batch size: " + str(batch_size)) ######## Don't need to print this
                print("Accuracy: " + str(accuracy)) ######## Don't need to print this
                print("------------------------------------------------") ######## Don't need to print this

    ######### Find confusion matrix for best model here, plot it in matplotlib, save the figure
