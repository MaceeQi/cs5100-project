...
def track_results(dataset, max_iter, solver, accuracy):
    file_name = (dataset + "_lr_results.txt")

    with open(file_name, 'a') as file:
        file.write("Max iterations: " + str(max_iter) + ", Solver: " + solver
...
if __name__ == "__main__":
    ...
    max_iters = [100, 200, 400, 800, 1000, 5000]
    ...
    for solver in solvers:
        for max_iter in max_iters:
            ...
            accuracy = accuracy_score(true_labels, predicted_labels)
            track_results("mnist", max_iter, solver, accuracy)
    ...
    path_dir = "/Users/maceeqi/Desktop/MSCS/7_Fall 2023_5100/Foundations of AI/Project/cs5100-project/mnist"
    evaluate_performance("MNIST", path_dir, best_actuals, best_preds)
